...
function save_images_GUI_callback(varargin)
    ...
    if findobj('type','figure','name','Save Images')
    ...
    if sdir ~= 0
        try
            ...
            for i = 1:nb_frames_temp
                ...
                switch type
                    case 'Binary Mask'
                        imwrite(uint16(logical(segmented_image)), [save_images_path filesep name sprintf(['%0' zero_pad 'd'],i) '.tif']);                 
                    case 'Labeled Mask'
                        imwrite(uint16(segmented_image), [save_images_path filesep name sprintf(['%0' zero_pad 'd'],i) '.tif']);                 
                    otherwise % 'As Shown in Preview'
                        imwrite(get_Superimpose_Image(), [save_images_path filesep name sprintf(['%0' zero_pad 'd'],i) formatted_format]);
                end
            end
...
bd_content_panel = sub_panel(h_tabpanel(4), [0 0 1 1], '', 'lefttop', green_blue, lt_gray, 14, 'serif');
set(bd_content_panel, 'borderwidth', 0);

title_panel = sub_panel(bd_content_panel, bg_title_panel_position, '', 'lefttop', green_blue, dark_gray, 14, 'serif');
label(title_panel, [0 0 1 1], 'Border Mask Generation', 'center', 'k', dark_gray, .8, 'sans serif', 'normal');
set(title_panel, 'borderwidth', 0);


bd_options_panel = sub_panel(bd_content_panel, options_panel_position, 'Options', 'lefttop', green_blue, lt_gray, 14, 'serif');
bd_display_panel = sub_panel(bd_content_panel, display_panel_position, ['Image: <' '>'], 'lefttop', green_blue, lt_gray, 14, 'serif');
...
mit_content_panel = sub_panel(h_tabpanel(5), [0 0 1 1], '', 'lefttop', green_blue, lt_gray, 14, 'serif');
set(mit_content_panel, 'borderwidth', 0);

title_panel = sub_panel(mit_content_panel, bg_title_panel_position, '', 'lefttop', green_blue, dark_gray, 14, 'serif');
label(title_panel, [0 0 1 1], 'Mitotic Mask Generation', 'center', 'k', dark_gray, .8, 'sans serif', 'normal');
set(title_panel, 'borderwidth', 0);

mit_options_panel = sub_panel(mit_content_panel, options_panel_position, 'Options', 'lefttop', green_blue, lt_gray, 14, 'serif');
mit_display_panel = sub_panel(mit_content_panel, display_panel_position, ['Image: <' '>'], 'lefttop', green_blue, lt_gray, 14, 'serif'); 
...
seed_content_panel = sub_panel(h_tabpanel(6), [0 0 1 1], '', 'lefttop', green_blue, lt_gray, 14, 'serif');
set(seed_content_panel, 'borderwidth', 0);

title_panel = sub_panel(seed_content_panel, bg_title_panel_position, '', 'lefttop', green_blue, dark_gray, 14, 'serif');
label(title_panel, [0 0 1 1], 'Seed Mask Generation', 'center', 'k', dark_gray, .8, 'sans serif', 'normal');
set(title_panel, 'borderwidth', 0);

seed_options_panel = sub_panel(seed_content_panel, options_panel_position, 'Options', 'lefttop', green_blue, lt_gray, 14, 'serif');
seed_display_panel = sub_panel(seed_content_panel, display_panel_position, ['Image: <' '>'], 'lefttop', green_blue, lt_gray, 14, 'serif'); 
...
%-----------------------------------------------------------------------------------------
% Seed Mask Content Panel
seed_load_content_panel = sub_panel(h_tabpanel(7), [0 0 1 1], '', 'lefttop', green_blue, lt_gray, 14, 'serif');
set(seed_load_content_panel, 'borderwidth', 0);

title_panel = sub_panel(seed_load_content_panel, bg_title_panel_position, '', 'lefttop', green_blue, dark_gray, 14, 'serif');
label(title_panel, [0 0 1 1], 'Import Seed Mask', 'center', 'k', dark_gray, .8, 'sans serif', 'normal');
set(title_panel, 'borderwidth', 0);

seed_load_options_panel = sub_panel(seed_load_content_panel, options_panel_position, 'Options', 'lefttop', green_blue, lt_gray, 14, 'serif');
seed_load_display_panel = sub_panel(seed_load_content_panel, display_panel_position, ['Image: <' '>'], 'lefttop', green_blue, lt_gray, 14, 'serif');
